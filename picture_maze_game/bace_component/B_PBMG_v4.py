...
while True:
    ...
    while True:
        view_chosen =  choice_checker("what view type would you like; above or in (enter <?> for preview): ",
                                      ["above", "in", "?"],
                                      "please enter above, in, or ?, for your response")
    ...
    exit_can_replace = cur_num_rooms - num_dead_ends
    chosen_room_replace = random.randint(exit_can_replace, cur_num_rooms)
    rooms_list[chosen_room_replace - 1][4] = 16

    print(f"{cur_num_rooms} - {num_dead_ends} = {exit_can_replace}")
    print(f"{exit_can_replace}, {cur_num_rooms}")
